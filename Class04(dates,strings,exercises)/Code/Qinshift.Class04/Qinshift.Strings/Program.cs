...
// using StringBuilder (only for info, will be explained in detail further on..)
...
string formattedString = someNumber.ToString("#,##0");
...
// (splits on specified character/delimeter )
...
// 4) *Join*
// => Concatenates the members of a collection (array),
